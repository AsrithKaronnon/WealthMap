...
export const PinSetupPrompt: React.FC = () => {
  ...
  return (
    <Dialog
      isOpen={isVisible}
      onClose={step === 1 ? handleSkip : handleSkipBiometrics}
      title={step === 1 ? 'Secure Your Finances' : 'PIN Saved!'}
      size="sm"
    >
      ...
      <p className="bg-muted/30 -mx-5 -mb-4 mt-4 p-4 text-xs text-center text-muted-foreground border-t border-border">
        {step === 1 
